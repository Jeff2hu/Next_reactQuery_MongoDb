...
const EditTopicForm = ({ id }: Props) => { 
  ...
  const editHandler = useCallback((e: FormEvent<HTMLFormElement>) => {
    e.preventDefault()
        ...
        : isError 
          ...
          : (
            <div className='grid place-items-center min-h-[40vh]'>
              <form className='flex flex-col gap-3 items-center' onSubmit={(e: FormEvent<HTMLFormElement>) => editMutation.mutate(e)}>
